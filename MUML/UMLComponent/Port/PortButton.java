...
public class PortButton extends OvalButton implements PortInterface,
		MouseInputListener {

	Port port;
	private Point prevMouseAt;

	public PortButton(int layout, UMLShapeContainer p) {
		port = new Port(layout, p);
		this.setSize(10, 10); // Size of the drag button
		this.setVisible(false);
		
		// Change the mouse to a mouse for adjusting the object
	...
	public void draw(Graphics g) {
		...
		// Place the resize point on the corresponding object
